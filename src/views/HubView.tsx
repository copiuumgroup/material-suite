...
import { Plus, Music, ArrowRight, UploadCloud, Activity, CloudDownload, Loader2, CheckCircle2, AlertTriangle, Play } from 'lucide-react';
...
const HubView: React.FC<Props> = ({ onOpenProject, onUpload }) => {
